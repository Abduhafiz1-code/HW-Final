    ...
    <div class="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900
        ...
        <div class="max-w-lg mx-auto">
            ...
            <div class="text-center mb-10 mt-4">
                ...
                <h2 class="text-xl font-black">{{ authStore.displayName || 'Foydalanuvchi' }}</h2>
            ...
            <div class="space-y-2 mb-6">
                <RouterLink to="/settings" class="w-full flex items-center justify-between p-4 bg-white dark:bg-white/5 rounded-2xl border border-slate-200 dark:border-white/10
                 hover:bg-slate-50 dark:hover:bg-white/10 transition text-left block">
                ...
                <RouterLink to="/history" class="w-full flex items-center justify-between p-4 bg-white dark:bg-white/5 rounded-2xl border border-slate-200 dark:border-white/10
                 hover:bg-slate-50 dark:hover:bg-white/10 transition text-left block">
                    <span class="font-bold text-slate-700 dark:text-white/80 flex items-center gap-3 text-sm">
               ...
               rounded-2xl border border-amber-200 dark:border-amber-500/20 hover:shadow-md transition text-left block">
                ...
                <RouterLink to="/feedback" class="w-full flex items-center justify-between p-4 bg-white dark:bg-white/5 rounded-2xl border border-slate-200 dark:border-white/10
                 hover:bg-slate-50 dark:hover:bg-white/10 transition text-left block">
                    <span class="font-bold text-slate-700 dark:text-white/80 flex items-center gap-3 text-sm">
                        <MessageSquareHeart :size="18" class="text-slate-400" /> Fikr bildirish
                    </span>
                    <ChevronRight :size="18" class="text-slate-300 dark:text-white/30" />
                </RouterLink>
            </div>
...
import { BarChart3, LogOut, Crown, ChevronRight, Sparkles, Gem, Settings as SettingsIcon, History, MessageSquareHeart } from '@lucide/vue';
