<template>
  <div class="min-w-0 flex-1 w-full">
    <div
      v-if="error"
      class="min-h-screen flex flex-col items-center justify-center gap-4 px-6 text-center bg-white dark:bg-slate-900">
      <div
        class="w-16 h-16 rounded-3xl bg-red-50 dark:bg-red-500/10 flex items-center justify-center">
      ...
      <p class="text-sm text-slate-500 dark:text-slate-400 max-w-xs">
        Sahifani qayta yuklab ko'ring. Agar xato takrorlansa, ilovadan chiqib
        qayta kiring.
      </p>
